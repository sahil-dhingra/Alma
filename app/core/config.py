...
class Settings:
    PROJECT_NAME: str = "O-1A assessment"
    VERSION: str = "1.0"
    API_TYPE: str = os.getenv("API_TYPE")
...
1. *Awards*
    a) **O-1A Evidentiary Criterion**: Documentation of the beneficiary’s receipt of nationally or internationally recognized prizes or awards for excellence in the field of endeavor.[1]
    b) **Relevant Examples and Considerations**:
        Examples:
...
2. *Membership*
    a) **O-1A Evidentiary Criterion**: Documentation of the beneficiary’s membership in associations in the field for which classification is sought, which require outstanding achievements of their members, as judged by recognized national or international experts in their disciplines or fields.[3]	
    b) **Relevant Examples and Considerations**:
        Examples:
...
4. *Judging*
    a) **O-1A Evidentiary Criterion**: Evidence of the beneficiary's participation on a panel, or individually, as a judge of the work of others in the same or in an allied field of specialization for which classification is sought.[7]	
    b) **Relevant Examples and Considerations**:
        Examples:
...
5. *Original contribution*
    a) **O-1A Evidentiary Criterion**: Evidence of the beneficiary's original scientific, scholarly, or business-related contributions of major significance in the field.[8]	
    b) **Relevant Examples and Considerations**: 
        Examples:
...
6. *Scholarly articles*
    a) **O-1A Evidentiary Criterion**: Evidence of the beneficiary's authorship of scholarly articles in the field, in professional journals, or other major media.[9]
    b) **Relevant Examples and Considerations**:
        Examples:
...
7. *Critical employment*
    a) **O-1A Evidentiary Criterion**: Evidence that the beneficiary has been employed in a critical or essential capacity for organizations and establishments that have a distinguished reputation.[12]	
    b) **Relevant Examples and Considerations**:
        Examples:
...
8. *High remuneration*
    a) **O-1A Evidentiary Criterion**: Evidence that the beneficiary has either commanded a high salary or will command a high salary or other remuneration for services as evidenced by contracts or other reliable evidence.[14]	
    b) **Relevant Examples and Considerations**:
        Examples:
